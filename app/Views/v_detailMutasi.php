...
<a href="<?= base_url('Mutasi') ?>" class="btn btn-success"><i class="fas fa-arrow-left"></i> Back</a>
<br>
<br>
<div class="row">
    <div class="col-sm-12">
                ...
                <tbody>
                    ...
                    foreach ($mutasi as $key => $value) : ?>
                        <tr>
                            ...
                            <td><?= $value['jumlah'] ?></td>
                            <td>
                                <button class="btn btn-flat btn-warning btn-xs" data-toggle="modal" data-target="#edit<?= $value['id_mutasi'] ?>"><i class="fas fa-edit"></i></button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
...
<?php foreach ($mutasi as $key => $value) { ?>
    <div class="modal fade" id="edit<?= $value['id_mutasi'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open('Mutasi/editData/' . $value['id_mutasi']);
                helper('text');
