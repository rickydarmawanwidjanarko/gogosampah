    ...
    <div class="card card-outline card-navy">
      ...
      <div class="card-body">
        ...
        <div class="input-group mb-3">
          <input type="text" name="username_nasabah" value="<?= old('username_nasabah') ?>" class="form-control" placeholder="Username">
        ...
        <div class="input-group mb-3">
          <input type="password" name="password_nasabah" value="<?= old('password_nasabah') ?>" class="form-control" placeholder="password">
